...
class RegQQ:
    ...
    def initPage(self, threadName, opener):
        ...
        Util.sendGetWithHeaderOpener("http://zc.qq.com/chs/ver.js?v=" + str(Util.getRandom()), opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=252190&r=" + str(Util.getRandom()), opener)
        response = Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/chs/numreg/init?r=" + str(Util.getRandom()) + "&cookieCode=undefined", opener)
        Util.setInitData(response, self.postdata)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=173276&r=" + str(Util.getRandom()), opener)
        response = Util.sendOtherCheckGetOpener("http://a.zc.qq.com/s.js?t=" + str(Util.getRandom()), opener)
        secCode = SecCode.getSecCode(response)
        Util.saveFileOpener("http://captcha.qq.com/getimage?aid=1007901&r=0.27110232775538023", "../../pic/" + threadName + ".jpg", opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=58030&timeused=0&seed=" + str(Util.getRandom()), opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=260714&r=" + str(Util.getRandom()), opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=278037&r=" + str(Util.getRandom()), opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=173279&r=" + str(Util.getRandom()), opener)
        Util.sendOtherCheckGetOpener("http://a.zc.qq.com/Cgi-bin/SecCheck?" + secCode + "&" + str(Util.getRandom()), opener)
        response = Util.sendGetWithHeaderOpener("http://zc.qq.com/chs/m.js?v=" + str(Util.getRandom()), opener)
    ...
    def inputValues(self, opener):
        ...
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/chs/common/dirty_check?nick=xiaoxie1&regType=1&r=" + str(Util.getRandom()), opener)
        time.sleep(2.41)
        ...
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=252193&r=" + str(Util.getRandom()), opener)
        Util.sendGetWithHeaderOpener("http://zc.qq.com/cgi-bin/common/attr?id=256401&r=" + str(Util.getRandom()), opener)
    ...
    def register(self, code, opener):
        ...
        print(self.postdata)
        response = Util.sendPostWithHeaderOpener("http://zc.qq.com/cgi-bin/chs/numreg/get_acc?r=" + "" + str(Util.getRandom()), self.postdata, Util.headers, opener)
        print(response.info())
        ret = response.read()
        print(ret)
        return ret
