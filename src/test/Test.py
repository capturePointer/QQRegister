...
def initPage():
    ...
    Util.sendGetWithHeader("http://zc.qq.com/cgi-bin/chs/numreg/init?r=" + str(Util.getRandom()) + "&cookieCode=undefined")
    ...
    Util.sendOtherCheckGet("http://a.zc.qq.com/Cgi-bin/SecCheck?" + SecCode.getSecCode(response) + "&" + str(Util.getRandom()))
