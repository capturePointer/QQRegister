...
def register():
    ...
    response = Util.sendPostWithHeader("http://zc.qq.com/cgi-bin/chs/numreg/get_acc?r=0.8787312490281419", Util.postdata, Util.headers)
    print(response.info())
    print(response.read())
...
def initPage():
    ...
    Util.sendGetWithHeader("http://zc.qq.com/cgi-bin/chs/numreg/init?r=0.7889855697086484&cookieCode=undefined")
    Util.sendGetWithHeader("http://zc.qq.com/cgi-bin/common/attr?id=173276&r=0.9579917662197109")
    Util.sendOtherCheckGet("http://a.zc.qq.com/s.js?t=0.62307900677164")
    Util.saveFile("http://captcha.qq.com/getimage?aid=1007901&r=0.27110232775538023", "1.jpg")
    ...
    Util.sendOtherCheckGet("http://a.zc.qq.com/Cgi-bin/SecCheck?y10ytLLT7B&0.5102277627441705")
    Util.sendGetWithHeader("http://zc.qq.com/chs/m.js?v=0.6149123950831218")
